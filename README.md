...
При наличии docblock каждое свойство ДОЛЖНО отделяться от других свойств, констант и методов одной пустой строкой.
...
НЕ СЛЕДУЕТ использовать следующие магические методы, кроме случаев, когда их использование не ухудшает, а улучшает понимание кода:
...
> Данные методы как правило усложняют чтение и понимание кода, как следствие его поддержку.
