...
Каждое свойство РЕКОМЕНДУЕТСЯ отделяться от других свойств, констант и методов одной пустой строкой.
...
Использование следующих магических методов НЕ РЕКОМЕНДУЕТСЯ:
